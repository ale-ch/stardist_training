...
def load_pickle(path: str) -> Any:
    """
    Loadeth a Python object from a pickle file.
...
def save_pickle(obj: Any, path: str) -> None:
    """
    Saveth a Python object to a pickle file.

    Parameters:
        obj (Any): The object to pickle.
        path (str): The path wherein to save the pickle file.
    """
...
if __name__ == '__main__':
    ...
    save_pickle((X_val, Y_val), 'val.pkl')
    ...
    save_pickle(history, 'history.pkl')
